...
<tr>
	...
	<?php endforeach; ?>
	    ...
	    <td align="right">DG Name</td>

	    <th align="center">:</th>

	    <td align="left"><input type="text" name="dg_name" value="" size="26" maxlength="60" class="bng_text" /></td>
	    </tr> 
	    ...
	    <td align="left"> <input type="text" name="date_from" class="easyui-datebox"/></td>
	    </tr>
...
<tr>
	    ...
	    <td align="left"> <input type="text" name="date_to" class="easyui-datebox"/></td>
	    </tr>
