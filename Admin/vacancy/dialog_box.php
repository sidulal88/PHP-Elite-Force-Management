...
<link href="../form_msg.css" rel="stylesheet" type="text/css" />
 <div id="dlg" class="easyui-dialog dataAdd" style="width:520px;height:320px;padding:10px 20px"
...
<form id="fm" action="" enctype="multipart/form-data" method="post" novalidate>
	 <table border="0" cellpadding="1" cellspacing="1" width="100%" class="dataAdd">
	  ...
	  <tr>
	    ...
	    <td align="left"><input type="text" name="web_link" id="web_link" value="" size="26" maxlength="100"  class="bng_text"/>
		Exp: www.google.com
		</td>
	    </tr>
