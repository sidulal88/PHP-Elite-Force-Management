...

{
	...
	$result = $Carrer_Vacancy -> get($vacancy_id);
	...
	if(isset($_POST['Submit'])) {
		...
		$Carrer_Vacancy -> edit();
		echo "<script type=\"text/javascript\">location.replace(\"record_edit.php?vacancy_id=$vacancy_id\");</script>";
...
<table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
 ...
 <div class="title_nav_bar">
    ...
    <div title="Vacancy Information" data-options="region:'center'" class="easyui-panel" >  
<form action="record_edit.php?vacancy_id=<?php echo $vacancy_id; ?>" enctype="multipart/form-data" method="post">
<input type="hidden" name="vacancy_id" value="<?php echo $vacancy_id; ?>" />
 ...
 <tr>
	  ...
	  <tr>
	    ...
	    <td align="right">Web Link</td>

	    <th align="center">:</th>

	    <td align="left"><input type="text" name="web_link" id="web_link" value="<?php echo $show_data['web_link']; ?>" size="26" maxlength="100"  class="bng_text"/></td>
	    </tr>
	   ...
	   <tr>
		  ...
		  <?php 
			...
			if (!in_array($file_ext, $image_ext)) {
				...
				?><a href="../../uploads/vacancy/<?php echo $show_data['attachment']; ?>" target="_blank" style="text-decoration:none; color:#0000CC">
			...
			{
			?>
				<img src="../../uploads/vacancy/<?php echo $show_data['attachment']; ?>" width="70" height="80" />
		<?php
			}
