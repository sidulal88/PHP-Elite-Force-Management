...
function grid_view() {
    ...
    $('#dg').datagrid({
        ...
        columns: [[
                ...
                {field: 'data_level', title: 'Unit Level', styler:cellStyler},
				{field: 'is_industry_status', title: 'Is Relavant with Industry ? ', styler:cellStyler},
				{field: 'sub_under_name', title: 'Sub Unit Of', styler:cellStyler},
				{field: 'location', title: 'Unit Location', styler:cellStyler},
				{field: 'address', title: 'Address', styler:cellStyler},
...
function editRecord2(){
            ...
            if (row){
                ...
                $('#fm').form('load',row);
                url = 'ajax_record_process.php?primery_key='+ row.unit_id +'&mode=save';
            }
}
		...
		function destroyRecord(){
            ...
            if (row){
                $.messager.confirm('Confirm','Are you sure you want to destroy this Record?',function(r){
                    if (r){
                        $.post('ajax_record_process.php',{primery_key:row.unit_id},function(result){
                            if (result.success){
...
function editRecord() {
	var row = $('#dg').datagrid('getSelected');
    location.replace('record_edit.php?unit_id=' + row.unit_id);
}
