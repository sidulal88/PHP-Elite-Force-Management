...
function grid_view() {
    ...
    $('#dg').datagrid({
        title: 'Police Authorised Strength List',
        iconCls: 'icon-save',
        pagination: 'true',
        toolbar: "#toolbar",
        rownumbers: 'true',
        ...
        pagePosition: 'bottom',
        idField: 'strength_id',
        url: '../ajax_admin_grid.php?gname=unit_strength',
        columns: [[
				 {field: 'unit_name', title: 'Unit Name', styler:cellStyler},
                {field: 'rank_name', title: 'Rank Name', styler:cellStyler},
				{field: 'authorised_strength', title: 'Strength', styler:cellStyler},
...
function editRecord(){
            ...
            if (row){
                ...
                $('#fm').form('load',row);
                url = 'ajax_record_process.php?primery_key='+ row.strength_id +'&mode=save';
            }
}
		...
		function destroyRecord(){
            ...
            if (row){
                $.messager.confirm('Confirm','Are you sure you want to destroy this Record?',function(r){
                    if (r){
                        $.post('ajax_record_process.php',{primery_key:row.strength_id},function(result){
                            if (result.success){
