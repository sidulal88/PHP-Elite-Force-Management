...
<table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
 ...
 <div class="title_nav_bar">
    <h1><?php echo NEWS_MANAGEMENT; ?></h1>
	 <h2><?php echo NEWS_CATEGORY_LIST.'-'.EDIT; ?></h2>
	<h3> <a href="newscategoryView.php" class="link_button"><?php echo NEWS_CATEGORY_LIST; ?></a></h3>
	 </div>
     
<form action="newscategoryEdit.php?cId=<?php echo $cId; ?>" enctype="multipart/form-data" method="post">
...
try
{
	...
	$result = $NewsCategory -> getCategory($cId);
	$show = $result -> fetch_array(MYSQL_ASSOC);
	if(isset($_POST['btnAdd'])) {
		$NewsCategory -> editCategory($cId);
		header("Location: newscategoryView.php?msg=Record has been updated successfully!");
	}
}
catch(Exception $e)
{
