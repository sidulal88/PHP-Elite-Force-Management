...
<link href="../form_msg.css" rel="stylesheet" type="text/css" />
 <div id="dlg" class="easyui-dialog dataAdd" style="width:520px;height:300px;padding:10px 20px"
...
<form id="fm" action="" enctype="multipart/form-data" method="post" novalidate>
	 <table border="0" cellpadding="1" cellspacing="1" width="100%" class="dataAdd">
	  ...
	  <tr>
	    ...
	    <td align="left"><input type="text" name="mission_name" id="mission_name" value="" size="26" maxlength="100"  class="bng_text"/></td>
	    </tr>
	  ...
	  <tr>
	    ...
	    <td align="left"><input type="text" name="location" id="location" value="" size="26" maxlength="100"  class="bng_text"/></td>
	    </tr>
	  ...
	  <tr>
	    ...
	    <td align="left"><input type="text" name="holder_name" id="holder_name" value="" size="26" maxlength="100"  class="bng_text"/></td>
	    </tr>
	  ...
	  <tr>
	    ...
	    <td align="left"> <input type="text" name="joining_date" class="easyui-datebox"/></td>
	    </tr>
	   <tr>
