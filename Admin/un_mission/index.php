...
function grid_view() {
    ...
    $('#dg').datagrid({
        ...
        pagePosition: 'bottom',
        idField: 'mission_id',
        url: '../ajax_directory_grid.php?gname=un_mission_list',
        columns: [[
                {field: 'mission_name', title: 'Mission Name', styler:cellStyler},
				{field: 'location', title: 'Location', styler:cellStyler},
				{field: 'joining_date', title: 'Date of Joining', styler:cellStyler},
				{field: 'holder_name', title: 'Person/ Group', styler:cellStyler},
				{field: 'attachment', title: 'Attachment', styler:cellStyler},
		...
		function destroyRecord(){
            ...
            if (row){
                $.messager.confirm('Confirm','Are you sure you want to destroy this Record?',function(r){
                    if (r){
                        $.post('ajax_record_process.php',{primery_key:row.mission_id},function(result){
                            if (result.success){
...
function editRecord() {
	var row = $('#dg').datagrid('getSelected');
    location.replace('record_edit.php?mission_id=' + row.mission_id);
}
