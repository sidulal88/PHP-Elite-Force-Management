...
<table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
 ...
 <div class="title_nav_bar">
    <h1><?php echo ARTICLE_MANAGEMENT; ?></h1>
	 <h2><?php echo ARTICLE_CATEGORY_LIST.'-'.DELETE; ?></h2>
	<h3> <a href="articlecategoryView.php" class="link_button"><?php echo ARTICLE_CATEGORY_LIST; ?></a></h3>
	 </div>   
	<form action="articlecategoryDelete.php?cId=<?php echo $cId; ?>" method="post">
...
try
{
	...
	if(isset($_POST['btnCancel'])) {
		echo "<script type=\"text/javascript\">location.replace(\"articlecategoryView.php\");</script>";
	} else if(isset($_POST['btnDelete'])) {
		$ArticleCategory -> delete($cId);
