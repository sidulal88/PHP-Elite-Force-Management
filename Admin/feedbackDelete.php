...
<table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
 ...
 <div class="title_nav_bar">
    <h1><?php echo ARTICLE_MANAGEMENT; ?></h1>
	 <h2><?php echo ARTICLE_LIST.'-'.DELETE; ?></h2>
	<h3> <a href="articleView.php" class="link_button"><?php echo ARTICLE_LIST; ?></a></h3>
	 </div>   
	<form action="feedbackDelete.php?fId=<?php echo $fId; ?>" method="post">
...

{
	...
	if(isset($_POST['btnCancel'])) {
		...
		echo "<script type=\"text/javascript\">location.replace(\"feedbackView.php\");</script>";
	} else if(isset($_POST['btnDelete'])) {

		$Feedback -> delete($fId);

		echo "<script type=\"text/javascript\">location.replace(\"feedbackView.php?msg=ok\");</script>";
