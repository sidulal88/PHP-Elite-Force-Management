...
function grid_view() {
    ...
    $('#dg').datagrid({
        ...
        pagePosition: 'bottom',
        idField: 'productid',
        url: '../ajax_admin_grid.php?gname=product_list',
        columns: [[
				 {field: 'productname', title: 'Product Name', styler:cellStyler},
				 {field: 'product_name_bangla', title: 'Product Name (Bangla)', styler:cellStyler},
				 {field: 'remarks', title: 'Remarks', styler:cellStyler},
...
function editRecord(){
            ...
            if (row){
                ...
                $('#fm').form('load',row);
                url = 'ajax_record_process.php?primery_key='+ row.productid +'&mode=save';
            }
}
		...
		function destroyRecord(){
            ...
            if (row){
                $.messager.confirm('Confirm','Are you sure you want to destroy this Record?',function(r){
                    if (r){
                        $.post('ajax_record_process.php',{primery_key:row.productid},function(result){
                            if (result.success){
