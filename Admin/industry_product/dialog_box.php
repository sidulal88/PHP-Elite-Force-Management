...
<form id="fm" action="" enctype="multipart/form-data" method="post">
	 <table border="0" cellpadding="1" cellspacing="1" width="100%" class="dataAdd">	 
	    ...
	    <td align="left"><input type="text" name="productname" value="" size="26" maxlength="60" class="bng_text" /></td>
	    </tr>
        <tr>
	<tr>

	    <td align="right">Product Name (Bangla)</td>

	    <th align="center">:</th>

	    <td align="left"><input type="text" name="product_name_bangla" value="" size="26" maxlength="60" class="bng_text" /></td>
	    </tr>
        <tr>
...
<tr>
	    ...
	    <td align="left"><input type="text" name="remarks" value="" size="26" maxlength="60" class="bng_text" /></td>
	    </tr>
        <tr>
