...
<table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
 ...
 <div class="title_nav_bar">
	 ...
	 <h2><?php echo PAGE_LIST.'-'.DELETE; ?></h2>
	<h3> <a href="moduleView.php" class="link_button"><?php echo PAGE_LIST; ?></a></h3>   
   </h3>
	 </div>
<form action="moduleDelete.php?mId=<?php echo $mId; ?>" method="post">
...

{
	...
	if(isset($_POST['btnCancel'])) {
		...
		echo "<script type=\"text/javascript\">location.replace(\"moduleView.php\");</script>";
