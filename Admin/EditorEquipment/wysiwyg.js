// Images Directory
imagesDir = "EditorEquipment/icons/";

// CSS Directory
cssDir = "EditorEquipment/styles/";

// Popups Directory
popupsDir = "EditorEquipment/popups/";
...
function generate_wysiwyg(textareaID,wysiwygWidth,wysiwygHeight) {
  ...
  toolbar2 += '<td>&nbsp;</td></tr></table>';  
	...
	var iframe = '<table cellpadding="0" bgcolor="#FFFFFF" cellspacing="0" border="1" style="width:' + wysiwygWidth + 'px; height:' + wysiwygHeight + 'px;border: 1px inset #000000;"><tr><td valign="top">\n'
