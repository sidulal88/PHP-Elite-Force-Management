...

{
	...
	if($result->num_rows <1) {
		...
		<tr>
			...
			<th width="" align="center" valign="top">'.EMAIL.'</th>

			<th width="" align="center" valign="top">'.DETAILS.'</th>
...

		{
			...
			echo '<tr class='.$class_name.'>
				...
				<td width="10%" align="center" valign="top">'.Common::convertToBanglaDate(date('Y-m-d', strtotime($show['recTime']))).'</td>

				<td width="10%" align="center" valign="top">'.$show['name'].'</td>

				<td width="25%" align="center" valign="top">'.$show['email'].'</td>

				<td width="40%" align="center" valign="top">';

				echo substr($show['message'], 0, $maxChar);

			if(strlen($show['message']) > $maxChar) {

				echo '..<a href="feedbackDetails.php?fId='.$show['id'].'">More</a>';
			...
			echo '</td>
				...
				<td width="30%" align="center" valign="top">
					...
					<a href="feedbackDelete.php?fId='.$show['id'].'"  class="button1">'.DELETE.'</a>
