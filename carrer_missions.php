	...
	<div class="wrapper"><?php include_once(INCLUDE_DIR.'/topBar.inc.php');?>
        ...
        <div class="contentWrapper">
			...
			<div class="blogContent">
				<div class ="welcome_head">Career > UN mission</div>
           	  <div class="pageBody">
			...
			try
			 {
				...
				$last_updated_on = Common::last_update_on("ipb_un_mission");
...
function grid_view() {
    ...
    $('#dg').datagrid({
        ...
        pagePosition: 'bottom',
        idField: 'mission_id',
		url: 'ajax_grid_data.php?gname=un_mission_list',
        columns: [[
                {field: 'mission_name', title: 'Mission Name',width:220, styler:cellStyler},
				{field: 'location', title: 'Location',width:150, styler:cellStyler},
                {field: 'joining_date', title: 'Date of Joining',width:100, styler:cellStyler},
				{field: 'holder_name', title: 'Person/ Group',width:150, styler:cellStyler},
				{field: 'attachment', title: 'Attachment',width:60, styler:cellStyler}
            ]]
